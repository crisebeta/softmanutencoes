...
class ProdutoForm(forms.ModelForm):
    ...
    def clean_preco(self):
        ...
        elif isinstance(preco, str) and not preco.strip():
    ...
    def clean_preco_custo(self):
        ...
        if isinstance(preco_custo, str) and preco_custo.strip():
            # Remove pontos (separadores de milhares) e substitui vírgula por ponto
        ...
        elif isinstance(preco_custo, str) and not preco_custo.strip():
            # Campo vazio, retorna None
            return None
        ...
        widgets = {
            ...
            'preco': forms.TextInput(
                attrs={
                    ...
                    'inputmode': 'numeric',
                    'pattern': '[0-9.,]*',
                    'type': 'text',  # Força tipo texto para evitar validação HTML5
                    'novalidate': 'novalidate'  # Remove validação HTML5
                }
            ),
